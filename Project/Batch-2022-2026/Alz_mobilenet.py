...
def create_model():
    ...
    checkpointer = ModelCheckpoint(filepath='../models/best_mnet_alz_model.hdf5', verbose=2, save_best_only=True, save_weights_only=True)
    checkpoint_cb = ModelCheckpoint('../models/mnet_alz_model.h5', save_best_only=True, monitor='val_accuracy',
                                    mode='max', verbose=1)
    ...
    plt.ylabel("True")
    plt.savefig("../static/vis/mnet_cnf.jpg")
    plt.close()
    ...
    # f.write(report)
    save_report_as_image(report, "../static/vis/mnet_clfrpt.png")
    ...
    plt.title("ROC Curve")
    plt.legend()
    plt.savefig("../static/vis/mnet_roc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet_prc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet_train_val_acc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet_train_val_loss.jpg")
    plt.close()



    # Save the trained model
    model.save('../models/mnet_trained_alz_model.h5')
