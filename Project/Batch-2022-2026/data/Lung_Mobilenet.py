...
def create_model():
    ...
    checkpointer = ModelCheckpoint(filepath='../models/best_mnet_lc_model.hdf5', verbose=2, save_best_only=True, save_weights_only=True)
    checkpoint_cb = ModelCheckpoint('../models/mnet_lc_model.h5', save_best_only=True, monitor='val_accuracy',
                                    mode='max', verbose=1)
    ...
    model.save('../models/mnet_trained_lung_cancer_model.h5')
