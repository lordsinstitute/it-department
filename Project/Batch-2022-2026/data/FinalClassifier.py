...
def createModel():
    # Set paths
    dataset_dir = '../colored_images'  # Change this
    IMG_SIZE = (224, 224)
    BATCH_SIZE = 32
    NUM_CLASSES = 5
    EPOCHS = 25
    ...
    # Callbacks
    checkpoint_cb = ModelCheckpoint('../models/cnn_mobilenet_dr_model.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
...
def load_and_predict(model_path, image_path, target_size=(224, 224), class_names=None):
    ...
    plt.axis('off')
    plt.savefig('static/predictions/result1.jpg')
...
def TestModel():
    ...
    model_path = 'models/cnn_mobilenet_dr_model.h5'
