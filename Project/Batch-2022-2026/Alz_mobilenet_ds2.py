...
def create_model():
    ...
    #test_folder = '../Combined Dataset/test'
    validate_folder = '../dataset/val'
    ...
    checkpointer = ModelCheckpoint(filepath='../models/best2_mnet_alz_model.hdf5', verbose=2, save_best_only=True, save_weights_only=True)
    checkpoint_cb = ModelCheckpoint('../models/mnet2_alz_model.h5', save_best_only=True, monitor='val_accuracy',
                                    mode='max', verbose=1)
    ...
    pretrained_model = MobileNetV2(include_top=False, weights='imagenet', input_shape=[*IMAGE_SIZE, 3])
    ...
    plt.ylabel("True")
    plt.savefig("../static/vis/mnet2_cnf.jpg")
    plt.close()
    ...
    # f.write(report)
    save_report_as_image(report, "../static/vis/mnet2_clfrpt.png")
    ...
    plt.title("ROC Curve")
    plt.legend()
    plt.savefig("../static/vis/mnet2_roc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet2_prc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet2_train_val_acc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/mnet2_train_val_loss.jpg")
    plt.close()



    # Save the trained model
    model.save('../models/mnet2_trained_alz_model.h5')
