...
def create_model():
    ...
    checkpoint = ModelCheckpoint('../models/best_incv3_model.h5', monitor='val_accuracy', save_best_only=True, verbose=1)
    ...
    model.save('../models/final_incv3_model.h5')

    # Confusion Matrix
    cm = confusion_matrix(y_true, y_pred)
    plot_confusion_matrix(cm, "../static/vis/incv3_cnf.jpg", class_labels)

    # Classification Report
    report = classification_report(y_true, y_pred, target_names=class_labels)
    print(report)
    save_report_as_image(report, "../static/vis/incv3_clfrpt.png")
    ...
    plt.legend()
    plt.savefig("../static/vis/incv3_roc.jpg")
    plt.close()
    ...
    plt.legend()
    plt.savefig("../static/vis/incv3_prc.jpg")
    plt.close()
    ...
    plt.ylabel("Accuracy")
    plt.legend()
    plt.savefig("../static/vis/incv3_train_val_acc.jpg")
    plt.close()
    ...
    plt.ylabel("Loss")
    plt.legend()
    plt.savefig("../static/vis/incv3_train_val_loss.jpg")
    plt.close()
