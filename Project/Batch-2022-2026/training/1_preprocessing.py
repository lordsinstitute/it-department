...
data.to_csv(r'../dataset/visualization.csv', index=False, header=True)  # preprocessed data without scaling
...
print(preprData)
preprData.to_csv(r'../dataset/preprocessedR.csv', index=False, header=True)